...
RETURNS TRIGGER AS $$
    BEGIN
        ...
        IF LENGTH(new.train_name) = 0 THEN
...
CREATE OR REPLACE TRIGGER trains_insert_trigger
...
CREATE OR REPLACE TRIGGER released_trains_insert_trigger
...
RETURNS TRIGGER AS $$
    BEGIN
        IF LENGTH(new.pnr_number) <= 0 THEN
...
CREATE OR REPLACE TRIGGER reservations_insert_trigger
...
CREATE OR REPLACE TRIGGER stations_insert_trigger
...
CREATE OR REPLACE TRIGGER routes_insert_trigger
